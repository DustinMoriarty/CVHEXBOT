...
class hexapod():
    ...
    def __init__(self,con, floor = 60):
        ...
        self.RF  = leg(con,'rightFront',24,25,26, (0, 3, 0), floor)
        self.RM  = leg(con,'rightMid',20,21,22, (0, 3, 0), floor)
        self.RB  = leg(con,'rightBack',16,17,18, (0, 3, 0), floor)

        self.LF  = leg(con,'leftFront',7,6,5, (0, 3, 0), floor)
        self.LM  = leg(con,'leftMid',11,10,9, (0, 3, 0), floor)
        self.LB  = leg(con,'leftBack',15,14,13, (0, 3, 0), floor)
    ...
    def tiltnone(self):
        self.LF.setFootY(self.floor)
        self.LM.setFootY(self.floor)
        self.LB.setFootY(self.floor)
        self.RF.setFootY(self.floor)
        self.RM.setFootY(self.floor)
        self.RB.setFootY(self.floor)
