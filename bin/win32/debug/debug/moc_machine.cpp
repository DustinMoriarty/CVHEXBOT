...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_machine_t, stringdata) + ofs \
...
const QMetaObject machine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_machine.data,
      qt_meta_data_machine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_machine.stringdata))
